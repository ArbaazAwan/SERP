...
export class DivisionComponent implements OnInit {
  ...
  saveDivision() {
    ...
    this.apiService.post(payLoad, ApiEndpoints.Division).subscribe((res) => {
      this.toastService.sendMessage({
        message: 'New Divsion Saved Successfully!',
  ...
  updateDivision() {
    ...
    this.apiService.update(payLoad, ApiEndpoints.Division).subscribe((res) => {
      this.toastService.sendMessage({
        message: ' Divsion Update Successfully!',
        type: NotificationType.success,
      });
      this.isUpdate = false;
      this.divisionForm.reset();
  ...
  deleteDivision(DivisionCode: number) {
    this.confirmService.confirm({
      message: `Are you sure that you want to delete this Divsion?`,
      header: 'Confirmation',
          ...
          .subscribe((res) => {
            ...
            if (res === true) {
              return this.toastService.sendMessage({
                message: ' Divsion Deleted Successfully!',
